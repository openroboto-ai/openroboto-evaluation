...
PRO_TARGETS = tuple(
    ScoreTarget(suite, perturbation) for suite in PRO_BASE_SUITES for perturbation in PRO_PERTURBATIONS
)
...
PROFILES = {
    "libero": EvaluationProfile("libero", "libero", BASE_TARGETS, _weights(BASE_TARGETS)),
    "libero_pro": EvaluationProfile("libero_pro", "libero_pro", PRO_TARGETS, _weights(PRO_TARGETS)),
    ...
    "libero_plus": EvaluationProfile("libero_plus", "libero_plus", BASE_TARGETS, PLUS_WEIGHTS),
}
